...
DATA_ROOT = "/mnt/DATA1/pankhi/gnr650/multitask_dino/DATA"

# Base project directory
PROJECT_ROOT = "/mnt/DATA1/pankhi/gnr650/multitask_dino/"
...
RESUME_PATH = os.path.join(SAVE_ROOT, "best_model_2.pth")
